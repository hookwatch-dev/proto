...
const (
	AuthService_Login_FullMethodName = "/hookwatch.cli.v1.AuthService/Login"
	AuthService_GetMe_FullMethodName = "/hookwatch.cli.v1.AuthService/GetMe"
)
...
//
// AuthService handles authentication for CLI clients.
type AuthServiceClient interface {
	// Login authenticates a user with email and password.
	Login(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*LoginResponse, error)
	// GetMe returns the current authenticated user (by access token).
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "hookwatch.cli.v1.AuthService",
